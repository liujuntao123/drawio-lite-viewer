...
(function()
{
	...
	Sidebar.prototype.updateEntries = function()
	{
		...
		if (Editor.currentTheme == 'min')
		{
			this.entries = [{title: mxResources.get('standard'),
				entries: [{title: mxResources.get('searchShapes'), id: 'search'},
	...
	Sidebar.prototype.initPalettes = function()
	{
		...
		if (Editor.currentTheme == 'min')
		{
			...
			this.addStencilPalette('flowchart', mxResources.get('flowchart'),
				dir + '/flowchart.xml',
				';html=1;' + mxConstants.STYLE_VERTICAL_LABEL_POSITION + '=bottom;' +
				mxConstants.STYLE_VERTICAL_ALIGN + '=top;strokeWidth=2;');
