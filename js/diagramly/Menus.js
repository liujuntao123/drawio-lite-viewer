...
(function()
{
	...
	Menus.prototype.init = function()
	{
		...
		this.put('insert', new Menu(mxUtils.bind(this, function(menu, parent)
		{
			...
			{
				var isLightViewer = Editor.currentTheme == 'min';
				this.addMenuItems(menu, ['insertRectangle', 'insertEllipse', 'insertRhombus',
					'-', 'insertEdge', '-', 'insertText', 'insertImage'], parent);

				if (!isLightViewer)
				{
					this.addMenuItems(menu, ['insertNote', 'insertLink',
						'-', 'createShape', 'insertPolygon', '-'], parent);
				}
